...
module Puppet::Util::Windows::COM
        ...
        def initialize(opts = {})
          ...
          FFI::MemoryPointer.new(:pointer) do |ppv|
            ...
            if Puppet::Util::Windows::COM.FAILED(hr)
              raise "CoCreateInstance failed (#{self.class}) #{hr} #{self.class::CLSID}."
            end
  ...
  attach_function_private :CoInitializeEx, [:lpvoid, :dword], :hresult
  ...
  def InitializeCom
    raise_if_hresult_failed(:CoInitializeEx, FFI::Pointer::NULL, 0)
